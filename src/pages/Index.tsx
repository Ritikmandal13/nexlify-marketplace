      ...
      <footer className="bg-gradient-to-r from-blue-50 to-purple-50 border-t border-gray-200 mt-8 mb-24 md:mb-0">
        <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <span className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Nexlify</span>
          ...
          <div className="text-xs text-gray-400 text-center md:text-right w-full md:w-auto">&copy; {new Date().getFullYear()} Nexlify. All rights reserved.</div>
        </div>
      </footer>
    </div>
  );
